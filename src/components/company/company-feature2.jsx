...
function CompanyFeature2(props){
  return(
    <div className="company-feature mb-5">
      ...
      <h4>Orestis Tanis</h4><br/>
      <p className="pl-4 pr-4" style={{textAlign: 'justify'}}>He is a total team leader. Workaholic & loves to do amazing stuff.</p><br/>
